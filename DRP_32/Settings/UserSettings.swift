        ...
        if let data6 = UserDefaults.standard.data(forKey: "bedTimeTasks"),
           let tasks6 = try? JSONDecoder().decode([Task].self, from: data6) {
            ...
            bedTimeTasks = [
                ...
                Task(title: "Lower the Thermostat", hour: 0, minute: 15, detail: "The circadian rhythm regulates the body’s temperature, which normally runs at 37 degrees. Lowering the thermostat to 18 degrees is a good temperature for sleep. The body will adapt to the lower room temperature and you will begin to feel drowsy.", type: "Bedtime"),
