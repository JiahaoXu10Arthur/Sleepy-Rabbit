...
struct SecondNewTaskView_Previews: PreviewProvider {
    static var previews: some View {
        SecondNewTaskView(selectedType: "Bedtime",isPresented: .constant(true))
